...
<<<<<<< HEAD
    public float[,] Dist_func =             {{0, 5.5f, 8f, 10},              // Близко
                                             {9.5f, 11f, 14f, 15},            // Средне
                                             {14.5f, 16, 60, 200}};          // Далеко
=======
...
>>>>>>> 0ee346f33d1f06866b8a0fe79b92270eab3ec10c
    ...
    private static string To_target_more_right = "СИЛЬНО ПРАВЕЕ";
    ...
    // Полученные данные
    public string Distance_45_left = "БЛИЗКО";
    public string Distance_45_right = "БЛИЗКО";
