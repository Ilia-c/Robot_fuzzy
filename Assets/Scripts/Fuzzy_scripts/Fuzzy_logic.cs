...
public class Fuzzy_logic : MonoBehaviour
{
    ...
    public float[,] Dist_func =             {{0, 1f, 2.5f, 4f},              // Òåëî
                                             {3.5f, 5f, 6f, 8f},             // Áëèçêî
                                             {7.5f, 10f, 14f, 15f},          // Ñðåäíå
                                             {14.5f, 16, 50, 200}};          // Äàëåêî

    public float[,] Dist_to_target_func =   {{0, 1.5f, 2f, 3},              // ÂÏËÎÒÍÓÞ
                                             {2.5f, 5f, 8f, 10},            // Áëèçêî
